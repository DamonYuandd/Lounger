...
<Hishop:CustomGridView ID="grdPromoteSales" runat="server" AutoGenerateColumns="False" ShowHeader="true" DataKeyNames="ActivityId" CssClass="articlelist" GridLines="None" RowStyle-CssClass="grdrow" HeaderStyle-CssClass="GridViewHeaderStyle" >
    <Columns>         
