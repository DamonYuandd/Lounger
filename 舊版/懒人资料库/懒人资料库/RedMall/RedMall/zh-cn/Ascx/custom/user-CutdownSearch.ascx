...
<%@ Import Namespace="Hishop.SystemServices" %>
 <span>货号
      ...
      $(document).ready(function() {
          $('#SearchResult_search_Common_CutdownSearch___txt_Private_CutdownSearch_SKU').keydown(function(e) {
              if (e.keyCode == 13) {
                  $("#btn_Private_CutdownSearch_Button").click();
              }
          })

          $('#SearchResult_search_Common_CutdownSearch___txt_Private_CutdownSearch_Keywords').keydown(function(e) {
              if (e.keyCode == 13) {
                  $("#btn_Private_CutdownSearch_Button").click();
              }
          })
      
          $('#SearchResult_search_Common_CutdownSearch___txt_Private_CutdownSearch_Price1').keydown(function(e) {
              if (e.keyCode == 13) {
                  $("#btn_Private_CutdownSearch_Button").click();
              }
          }) 

          $('#SearchResult_search_Common_CutdownSearch___txt_Private_CutdownSearch_Price2').keydown(function(e) {
              if (e.keyCode == 13) {
                  $("#btn_Private_CutdownSearch_Button").click();
              }
          })
          ...
          $('#pager_txtGoto').keydown(function(e) {
              if (e.keyCode == 13) {
                  $("#SearchResult_pager_btnGoto").click();
              }
          })
      });
  </script>
