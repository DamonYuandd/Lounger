                ...
                <tr>
                    <td align="center">
                        <table>
                            <tr>
                                <td >
                                    <input type="button" name='<%# Eval("VoteId") %>' id="btnOK" class="votebtn" value="Ã·Ωª" onclick='voteOption(this.name , document.getElementById("<%# this.NamingContainer.ClientID + Convert.ToString(Eval("VoteId"))%>_Value").value);' />
                                </td>
                            </tr>
                        </table>
                    </td>
