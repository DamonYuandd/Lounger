...
<table width="100%" class="adtop" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
   <tr id="tblrbtn" runat="server">
        <td style="padding-top:10px;width:100%; text-align:center;">
           <div class="clear-btn"><asp:LinkButton ID="btnDeleteListItems" runat="server" Text="清除" ></asp:LinkButton ></div>
        </td>
    </tr>
</table>