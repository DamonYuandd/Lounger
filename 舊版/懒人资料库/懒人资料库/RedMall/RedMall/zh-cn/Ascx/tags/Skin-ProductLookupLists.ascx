...
<div id="divProductLookupLists" style="border:solid 1px #DDDDDD;width:100%;" runat="server">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="100%">
                            ...
                            <asp:Literal ID="lblLookupName" runat="server" Text='<%# Eval("DisplayName") %>'></asp:Literal>
                            </strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-left:26px;">
                            <asp:Literal ID="lblItemValue" runat="server" Text='<%# Eval("ItemValue") %>'></asp:Literal>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <div style="text-align:left;border-top:dashed 1px #DDDDDD;margin-left:6px;margin-right:6px;padding-top:6px;">
