...
<div id="header" class="grid_24">
    ...
    <form name="search" action="http://livedemo00.template-help.com/osc_33478/advanced_search_result.php" method="get">		<div class="input-width fl_left">
		...
		<input type="image" src="includes/languages/english/images/buttons/button_search_prod.png" alt=""  class="button_search_prod fl_left" /></form>                                        
                ...
                <div class="languages fl_right"><a href="file:///D:/匼第/demo/new demo/privacy.php"><img src="includes/languages/english/images/icon.gif" alt="English" title=" English " width="28" height="20" /></a></div>
                    <div class="currencies fl_right">
                        <label class="fl_left">Currencies: </label><form name="currencies" action="http://livedemo00.template-help.com/osc_33478/privacy.php" method="get"><select name="currency" onChange="this.form.submit();" class="select fl_right"><option value="USD" selected="selected">U.S. Dollar</option><option value="EUR">Euro</option></select></form></div>
...
<div class="bg_body row_3">
    <div id="bodyWrapper" class="container_24 ofh">
           <div class="grid_24"><div class="breadcrumb">&nbsp;&nbsp;<a href="http://livedemo00.template-help.com" class="headerNavigation">Top</a> &raquo; <a href="file:///D:/匼第/demo/new demo/index.php" class="headerNavigation">Catalog</a> &raquo; <a href="file:///D:/匼第/demo/new demo/privacy.php" class="headerNavigation">Privacy Notice</a></div></div>
    </div>
</div>
