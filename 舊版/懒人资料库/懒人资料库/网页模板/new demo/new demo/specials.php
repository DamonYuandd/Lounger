...
<div id="header" class="grid_24">
    ...
    <form name="search" action="http://livedemo00.template-help.com/osc_33478/advanced_search_result.php" method="get">		<div class="input-width fl_left">
		...
		<input type="image" src="includes/languages/english/images/buttons/button_search_prod.png" alt=""  class="button_search_prod fl_left" /></form>                                        
                ...
                <div class="languages fl_right"><a href="file:///D:/匼第/demo/new demo/specials.php"><img src="includes/languages/english/images/icon.gif" alt="English" title=" English " width="28" height="20" /></a></div>
                    <div class="currencies fl_right">
                        <label class="fl_left">Currencies: </label><form name="currencies" action="http://livedemo00.template-help.com/osc_33478/specials.php" method="get"><select name="currency" onChange="this.form.submit();" class="select fl_right"><option value="USD" selected="selected">U.S. Dollar</option><option value="EUR">Euro</option></select></form></div>
...
<!-- menu cart END-->
  	<ul class="menu fl_left">		
            ...
            <li class="menu_item selected" onClick="document.location='http://livedemo00.template-help.com/osc_33478/specials.php'"><div class="wrapper_menu-t"><a>Specials</a></div></li>
...
<div class="bg_body row_3">
    <div id="bodyWrapper" class="container_24 ofh">
           <div class="grid_24"><div class="breadcrumb">&nbsp;&nbsp;<a href="http://livedemo00.template-help.com" class="headerNavigation">Top</a> &raquo; <a href="file:///D:/匼第/demo/new demo/index.php" class="headerNavigation">Catalog</a> &raquo; <a href="file:///D:/匼第/demo/new demo/specials.php" class="headerNavigation">Specials</a></div></div>
    </div>
</div>
...
<div class="title-t">	<div class="title-r">		<div class="title-b">			<div class="title-l">				<div class="title-tl">					<div class="title-tr">						<div class="title-bl">							<div class="title-br"><h1>Get Them While They're Hot!</h1>
...
<div class="result result1_top"><div class="result1_bottom">
        ...
        <div class="cl_both result_top_padd ofh">
        	<div class="fl_left result_left"><span>Displaying <strong>1</strong> to <strong>6</strong></span> (of <strong>6</strong> specials)</div>
...
<div class="prods_content"><ul class="row" id="row-0"><li style="width:230px;" class="wrapper_prods">
<div class="box_2">
     ...
     <div class="border-bot2">
      <div class="border-left2">
       <div class="left-top-corner2">
		...
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Set ipsum dolor sit amet, consectetur lorem</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$39.99</span> <del class="fl_left">$49.99</del></h2>
...
</li><li class="prods_vseparator"><img src="images/spacer.gif" alt="" width="1" height="1" /><li style="width:230px;" class="wrapper_prods">
<div class="box_2">
   <div class="border-top2">
    <div class="border-right2">
     <div class="border-bot2">
       ...
       <div class="left-top-corner2">
        <div class="right-top-corner2">
         <div class="right-bot-corner2">
          <div class="left-bot-corner2">
           <div class="inner4">
		<div class="pic_padd wrapper_pic_div" style="width:187px;height:149px;"><a class="prods_pic_bg" href="file:///D:/匼第/demo/new demo/product_info.php" style="width:187px;height:149px;"><img src="images/products/berber_carpet_1.png" alt="Berber Carpet" title=" Berber Carpet " width="187" height="149"  style="width:187px;height:149px;" /></a></div>
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Berber Carpet</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$30.00</span> <del class="fl_left">$35.99</del></h2>
			<div class="button__padd"><div class="bg_button2" onMouseOut="this.className='bg_button2';" onMouseOver="this.className='bg_button2-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/products_new.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-cart"></span><span class="ui-button-text">Add&nbsp;to&nbsp;cart</span></a></div></div></div></div></div></div></div></div></div><div class="bg_button22" onMouseOut="this.className='bg_button22';" onMouseOver="this.className='bg_button22-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/product_info.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">Details</span></a></div></div></div></div></div></div></div></div></div></div>
		</div>
</div>
   </div>
     ...
     <div class="border-bot2">
      <div class="border-left2">
       <div class="left-top-corner2">
		...
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Calabria in Biscotti 12x 12 field tile</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$30.00</span> <del class="fl_left">$39.99</del></h2>
			<div class="button__padd"><div class="bg_button2" onMouseOut="this.className='bg_button2';" onMouseOver="this.className='bg_button2-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/products_new.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-cart"></span><span class="ui-button-text">Add&nbsp;to&nbsp;cart</span></a></div></div></div></div></div></div></div></div></div><div class="bg_button22" onMouseOut="this.className='bg_button22';" onMouseOver="this.className='bg_button22-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/product_info.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">Details</span></a></div></div></div></div></div></div></div></div></div></div>
		</div>
</div>
   </div>
...
</ul><ul><li class="prods_hseparator"><img src="images/spacer.gif" alt="" width="1" height="1" /></li></ul><ul class="row" id="row-4"><li style="width:230px;" class="wrapper_prods">
<div class="box_2">
   <div class="border-top2">
    <div class="border-right2">
     <div class="border-bot2">
      <div class="border-left2">
       <div class="left-top-corner2">
		...
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Kraus Augusta Cherry Laminate</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$29.99</span> <del class="fl_left">$38.99</del></h2>
			<div class="button__padd"><div class="bg_button2" onMouseOut="this.className='bg_button2';" onMouseOver="this.className='bg_button2-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/products_new.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-cart"></span><span class="ui-button-text">Add&nbsp;to&nbsp;cart</span></a></div></div></div></div></div></div></div></div></div><div class="bg_button22" onMouseOut="this.className='bg_button22';" onMouseOver="this.className='bg_button22-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/product_info.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">Details</span></a></div></div></div></div></div></div></div></div></div></div>
		</div>
</div>
   </div>
       ...
       <div class="left-top-corner2">
        <div class="right-top-corner2">
         <div class="right-bot-corner2">
          <div class="left-bot-corner2">
           <div class="inner4">
		<div class="pic_padd wrapper_pic_div" style="width:187px;height:149px;"><a class="prods_pic_bg" href="file:///D:/匼第/demo/new demo/product_info.php" style="width:187px;height:149px;"><img src="images/products/kraus_spruce_laminate_1.png" alt="Kraus Spruce Laminate" title=" Kraus Spruce Laminate " width="187" height="149"  style="width:187px;height:149px;" /></a></div>
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Kraus Spruce Laminate</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$5.00</span> <del class="fl_left">$64.95</del></h2>
			<div class="button__padd"><div class="bg_button2" onMouseOut="this.className='bg_button2';" onMouseOver="this.className='bg_button2-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/products_new.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-cart"></span><span class="ui-button-text">Add&nbsp;to&nbsp;cart</span></a></div></div></div></div></div></div></div></div></div><div class="bg_button22" onMouseOut="this.className='bg_button22';" onMouseOver="this.className='bg_button22-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/product_info.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">Details</span></a></div></div></div></div></div></div></div></div></div></div>
		</div>
</div>
   </div>
       ...
       <div class="left-top-corner2">
        <div class="right-top-corner2">
         <div class="right-bot-corner2">
          <div class="left-bot-corner2">
           <div class="inner4">
		<div class="pic_padd wrapper_pic_div" style="width:187px;height:149px;"><a class="prods_pic_bg" href="file:///D:/匼第/demo/new demo/product_info.php" style="width:187px;height:149px;"><img src="images/products/gerflor_damier_black_white_super_solar_vinyl_1.png" alt="Gerflor Damier Black & White Super Solar Vinyl" title=" Gerflor Damier Black & White Super Solar Vinyl " width="187" height="149"  style="width:187px;height:149px;" /></a></div>
		<div class="box-padd">
			<div class="name name_padd equal-height"><span><a href="file:///D:/匼第/demo/new demo/product_info.php">Gerflor Damier Black & White Super Solar Vinyl</a></span></div>
			<div class="desc desc_padd">Laoreet dolore magnaorem ipsum dolor ser adipiscin...</div>
			<h2 class="price price_padd"><b>Our Price:&nbsp;&nbsp;&nbsp;</b><span class="productSpecialPrice fl_left">$5.99</span> <del class="fl_left">$39.99</del></h2>
			<div class="button__padd"><div class="bg_button2" onMouseOut="this.className='bg_button2';" onMouseOver="this.className='bg_button2-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/products_new.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-cart"></span><span class="ui-button-text">Add&nbsp;to&nbsp;cart</span></a></div></div></div></div></div></div></div></div></div><div class="bg_button22" onMouseOut="this.className='bg_button22';" onMouseOver="this.className='bg_button22-act';"><div class="button-b"><div class="button-r"><div class="button-l"><div class="button-t"><div class="button-tl"><div class="button-tr"><div class="button-bl"><div class="button-br"><a href="file:///D:/匼第/demo/new demo/product_info.php" id="tdb1" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary ui-priority-secondary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-e"></span><span class="ui-button-text">Details</span></a></div></div></div></div></div></div></div></div></div></div>
		</div>
</div>
   </div>
...
<div class="grid_24 footer_menu  footer">
  	...
  	<ul>		
            <li class="footer_item un selected"><a onClick="document.location='http://livedemo00.template-help.com/osc_33478/specials.php'">Specials</a></li>
