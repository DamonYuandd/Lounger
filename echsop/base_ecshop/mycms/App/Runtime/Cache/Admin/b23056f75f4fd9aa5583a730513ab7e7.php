	...
	<thead>
		<tr>
			<th width="600">
				...
				<input type="button" value="上传产品" class="button-img-add" onclick="goToUrl('__APP__/Admin/Goods/edit/lang/<?php echo $_GET["lang"];?>/cid/<?php echo $_GET["cid"];?>')"/>
				<input type="button" value="批量上传" class="button-img-add" style="background:url(__ADMIN__/Public/imgs/add2.png) no-repeat;padding-left: 8px;" onclick="goToUrl('__APP__/Admin/Goods/groupUp/lang/<?php echo $_GET["lang"];?>/cid/<?php echo $_GET["cid"];?>/hd/<?php echo ($_SESSION['hardware']); ?>')"/>
				</div>
...
<table class="grid-table" border="1" cellpadding="0" cellspacing="0"> 
	...
	<?php if(!empty($dataList)): ?><tbody>
		<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> 
		    ...
		    <td><?php getLangTextTitle($vo['lang']);?> <a href="__APP__/Admin/Goods/edit/id/<?php echo ($vo["id"]); ?>/lang/<?php echo ($vo["lang"]); ?>/cid/<?php echo ($vo["category_id"]); ?>"><?php echo ($vo["title"]); ?></a>
		    <?php if(!empty($vo["image"])): ?><img alt="有封面图片" title="有封面图片" src="__ADMIN__/Public/imgs/gtk-image.png"><?php endif; ?>
		    ...
		    <td><a href="__APP__/Admin/Goods/edit/id/<?php echo ($vo["id"]); ?>/lang/<?php echo ($vo["lang"]); ?>/cid/<?php echo ($vo["category_id"]); ?>"><img src="__ADMIN__/Public/imgs/edit.png" /></a>&nbsp;&nbsp;
		    <a href="javascript:void(0)" onclick="javascript:deleteData('__APP__/Admin/Goods/deleteById/id/<?php echo ($vo["id"]); ?>/cid/<?php echo ($vo["category_id"]); ?>');"><img src="__ADMIN__/Public/imgs/cross.png" /></a></td>
		</tr><?php endforeach; endif; else: echo "" ;endif; ?>
	</tbody>
		<?php else: ?>
	<tbody>
		<tr>
			<td colspan="11" align="center" style="color:red;">没有找到数据！！！<a href="__APP__/Admin/Goods/edit/cid/<?php echo $_GET["cid"];?>/lang/<?php echo $_GET['lang']; ?>">添加</a></td>
		</tr>
	</tbody><?php endif; ?>
	<tfoot>
		<tr>
