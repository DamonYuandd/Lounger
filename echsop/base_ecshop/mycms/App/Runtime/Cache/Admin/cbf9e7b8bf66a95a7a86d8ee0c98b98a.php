	...
	<div class="header-title" style="background-color:#0e0e0d;">
        ...
        <div id="top_right">
			...
			if( $_SESSION['hardware']=='pc' ) {
				echo '<a href="__APP__/Admin/Index/index/hardware/mobile" style="font-size:14px;font-weight: bold;" target="_top"><img src="__ADMIN__/Public/imgs/iphone.png" align="absmiddle"> 使用手机版</a>';
			} else {
				echo '<a href="__APP__/Admin/Index/index/hardware/pc" style="font-size:14px;font-weight: bold;" target="_top"><img src="__ADMIN__/Public/imgs/windows_client.png" align="absmiddle"> 使用电脑版</a>';
			}
			?>
			<!--语言切换
            <select id="lang">
