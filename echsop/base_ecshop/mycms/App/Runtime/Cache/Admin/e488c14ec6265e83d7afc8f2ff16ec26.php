...
<div id="sidemenu">
  <ul>
	...
	<?php if(($module)  ==  "Goods"): ?><?php if(($alias)  ==  "Goods"): ?><li class="fixed"><a href="__APP__/Admin/Goods/imgsLoad" class="openMain">上传产品图片</a></li>
		<li class="fixed"><a href="__APP__/Admin/Goods/inquire/cid/<?php echo $_GET["cid"];?>/lang/<?php echo $_GET["lang"];?>" class="openMain"> 产品询价</a></li><?php endif; ?>
	...
	<?php if(($module)  ==  "About"): ?><li class="fixed"><a href="__APP__/Admin/News/category/cid/<?php echo $_GET["cid"];?>/lang/<?php echo $_GET["lang"];?>" class="openMain"> 分类管理</a></li><?php endif; ?>
	<?php if(($module)  ==  "News"): ?><li class="fixed"><a href="__APP__/Admin/News/category/cid/<?php echo $_GET["cid"];?>/lang/<?php echo $_GET["lang"];?>" class="openMain"> 分类管理</a></li>
		<li class="subtitle fixed">
			<a class="action openMain checked-action" href="__APP__/Admin/Goods/isHomeList"> 推荐管理<img src="__ADMIN__/Public/imgs/arrow-down.png" width="7" height="4" alt="arrow" class="arrow"> </a>
	  		<ul class="submenu" style="display: none; ">
	...
	<?php if(($module)  ==  "System"): ?><li><a href="__APP__/Admin/System/index/cid/base" class="openMain">网站基本信息</a></li>
		...
		<li><a href="__APP__/Admin/System/index/cid/theme" class="openMain">更换网站整体风格</a></li>
		<li><a href="__APP__/Admin/System/index/cid/img" class="openMain">图片管理</a></li>
		<li class="fixed"><a href="__APP__/Admin/System/index/cid/tertiarycode" class="openMain" style="padding: 9px 10px 9px 15px;">第三方代码<span style="color:#999">(流量、微博、分享)</span></a></li>
		<li class="fixed"><a href="__APP__/Admin/System/index/cid/user" class="openMain">网站管理员</a></li><?php endif; ?>
	<?php if(($module)  ==  "Guestbook"): ?><li class="fixed"><a href="__APP__/Admin/Guestbook/index/c_root/21/cid/1224/lang/zh-cn" class="openMain"> 查看留言</a></li><?php endif; ?>
  </ul>
</div>
</body>
</html>