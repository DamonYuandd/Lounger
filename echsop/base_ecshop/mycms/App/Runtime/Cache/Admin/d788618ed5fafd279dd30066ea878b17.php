...
<form action="__APP__/Admin/System/saveSetting" method="post" class="form">
   ...
   <fieldset>
       <ul class="align-list">
		   ...
		   <li>
           	   <label>二维码</label>
			   <input type="radio" name="is_twoCode" value="1" <?php if($system['is_twoCode'] == 1) echo "checked"; ?>> 开启&nbsp;&nbsp;&nbsp;<input type="radio" name="is_twoCode" value="0" <?php if($system['is_twoCode'] == 0) echo "checked"; ?>> 关闭
           </li>
		   <li>
